...
# Let us define a CreditCard class that will contain a set of known valid types, and
...
class CreditCard
  VALID_TYPES = [
    CreditCardType.new("AMEX", /^3[47][0-9]{13}$/),
    CreditCardType.new("DCCB", /^30[0-5]\d{11}$/),
    CreditCardType.new("DISC", /^6(?:011|5[0-9]{2})[0-9]{12}$/),
    CreditCardType.new("MC", /^5[1-5][0-9]{14}$/),
    CreditCardType.new("VISA", /^4[0-9]{12}(?:[0-9]{3})?$/),
